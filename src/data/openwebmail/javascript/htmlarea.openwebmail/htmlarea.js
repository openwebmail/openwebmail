...
//
// $Id: htmlarea.js,v 1.22 2003/09/02 09:25:41 mishoo Exp $
...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		insertsound: [ "Insert Sound", "images/ed_sound.gif", false, function(e) {e.execCommand("insertsound");} ],
...
HTMLArea.prototype.generate = function () {
	...
	function initIframe() {
		...
		html += "</head>\n";
		html += "<body dir='"+editor.config.pageDirection+"'>\n";
...
HTMLArea.prototype._insertSound = function() {
	...
	this._popupDialog("insert_sound.html", function(param) {
		...
		for (var field in param) {
			...
			switch (field) {
			    case "f_url"      :	embed.src=value; a.href=value; break;
