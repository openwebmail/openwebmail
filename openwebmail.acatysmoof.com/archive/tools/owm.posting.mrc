...
<DefineVar chop>
PERMA-LINK
<a href="http://www.openwebmail.org/archive/search.pl?msgid=$MSGID:U$" class="msgLinks">permalink</a>
</DefineVar>

<DefineVar chop>
REPLY-LINK
<a href="javascript:void(0);" onClick="window.open('/archive/tools/post.pl?list=$LIST-NAME$&msgid=$MSGID:U$&msgsubject=$SUBJECTNA:U$','replywindow','height=450,width=600,status=yes,toolbar=no,menubar=no,location=no');" class="msgLinks">reply</a>
</DefineVar>
